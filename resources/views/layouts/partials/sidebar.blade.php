    <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
        <a class="navbar-brand me-lg-5" href="{{ route('dashboard') }}">
            <img class="navbar-brand-dark" src="{{ asset('theme/assets/img/brand/light.svg') }}" alt="Volt logo" />
            <img class="navbar-brand-light" src="{{ asset('theme/assets/img/brand/dark.svg') }}" alt="Volt logo" />
        </a>
            ...
            <div
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="{{ asset('theme/assets/img/team/profile-picture-3.jpg') }}"
                ...
                {{-- <li class="nav-item">
                    <a href="../../index.html" class="nav-link d-flex align-items-center">
                        <span class="sidebar-icon">
                            <img src="{{ asset('theme/assets/img/brand/light.svg') }}" height="20" width="20"
                                alt="Volt Logo">
                        </span>
                ...
                <li class="nav-item">
                    <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        ...
                        <span>
                            ...
                            <span class="sidebar-text">Gestion des Biens</span>
                        </span>
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                        <ul class="flex-column nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('appartement.type.index') }}">
                                    <span class="sidebar-text">Type d'appartements</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('terrain.type.index') }}">
