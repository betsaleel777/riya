   <!-- Core -->
   <script src="{{ asset('theme/vendor/@popperjs/core/dist/umd/popper.min.js') }}" type="text/javascript"></script>
   <script src="{{ asset('theme/vendor/bootstrap/dist/js/bootstrap.min.js') }}" type="text/javascript"></script>

   <!-- Vendor JS -->
   <script src="{{ asset('theme/vendor/onscreen/dist/on-screen.umd.min.js') }}" type="text/javascript"></script>
