...
@section('content')
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                @if ($searching)
                    <a href="{{ route('client.index') }}" class="btn btn-primary d-inline-flex align-items-center">
                ...
                <a href="{{ route('client.export') }}" class="btn btn-primary d-inline-flex align-items-center">
                    <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <a href="{{ route('client.create') }}" class="btn btn-primary d-inline-flex align-items-center">
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <div class="mb-3 w-50">
                @if (!$searching)
                    <form class="row g-2" action="{{ route('client.search') }}" method="POST">
                        @csrf
                        <div class="col">
