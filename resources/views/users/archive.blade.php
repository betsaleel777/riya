...
@section('content')
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('user.index') }}">Liste utilisateurs</a></li>
                <li class="breadcrumb-item active" aria-current="page">Utilisateurs Archivé</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Utilisateurs</h1>
            </div>
            <div>
                @if ($searching)
                    <a href="{{ route('user.trashed') }}" class="btn btn-primary d-inline-flex align-items-center">
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <div class="mb-3 w-25">
                <form action="{{ route('user.searchTrashed') }}" method="POST">
                    @csrf
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0 w-50">Email</th>
                            <th class="border-0 w-50">Admin</th>
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge bg-info">Gérant</span>
                                    @endif
                                </td>
                                <td>
                                    {{ $user->created_at }}
                                ...
                                <td>
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-4">
                                            <button
                                                onclick="question({{ json_encode(['name' => $user->name, 'link' => 'destroy/' . $user->id]) }})"
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="alert alert-light text-center" role="alert">
                                        <h6>Liste des utilisateurs vide</h6>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
